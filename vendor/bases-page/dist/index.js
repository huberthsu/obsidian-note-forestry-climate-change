...
var calendar_inline_default = `var C=["January","February","March","April","May","June","July","August","September","October","November","December"];function y(e){return String(e).padStart(2,"0")}function D(e,t){return new Date(e,t+1,0).getDate()}function N(e,t){return new Date(e,t,1).getDay()}function w(e,t,a){let c=document.createElement("div");c.className="bases-calendar-day"+(t?" is-today":"");let l=document.createElement("span");if(l.className="bases-calendar-daynum",l.textContent=String(e),c.appendChild(l),a&&a.length>0){let n=document.createElement("div");n.className="bases-calendar-entries",a.forEach(s=>{let r=document.createElement("a");r.href=s.href,r.className="internal internal-link bases-calendar-chip",r.dataset.slug=s.slug,r.title=s.tooltip,r.textContent=s.title,n.appendChild(r)}),c.appendChild(n)}return c}function b(e,t,a,c,l){let n=e.querySelector(".bases-calendar-days"),s=e.querySelector(".bases-calendar-label");if(!n||!s)return;n.innerHTML="";let r=N(t,a),u=D(t,a),h=Math.ceil((r+u)/7)*7,o=document.createDocumentFragment();for(let i=0;i<h;i++){let d=i-r+1;if(d<1||d>u){let m=document.createElement("div");m.className="bases-calendar-day is-outside",o.appendChild(m);continue}let p=t+"-"+y(a+1)+"-"+y(d);o.appendChild(w(d,p===l,c[p]))}n.appendChild(o),s.textContent=C[a]+" "+t,e.dataset.currentYear=String(t),e.dataset.currentMonth=String(a),document.dispatchEvent(new CustomEvent("render"))}function L(e,t){if(e.dataset.calendarReady==="1")return;e.dataset.calendarReady="1";let a=e.querySelector('script[type="application/json"]');if(!a)return;let c;try{c=JSON.parse(a.textContent)}catch{return}let l=c.byDay||{},n=new Date,s=n.getFullYear()+"-"+y(n.getMonth()+1)+"-"+y(n.getDate()),r=Number(e.dataset.initialYear),u=Number(e.dataset.initialMonth);n.getFullYear()!==r||n.getMonth()!==u?b(e,n.getFullYear(),n.getMonth(),l,s):(e.dataset.currentYear=String(r),e.dataset.currentMonth=String(u));let h=v=>{let M=Number(e.dataset.currentYear),S=Number(e.dataset.currentMonth),E=new Date(M,S+v,1);b(e,E.getFullYear(),E.getMonth(),l,s)},o=e.querySelector(".bases-calendar-prev"),i=e.querySelector(".bases-calendar-next"),d=e.querySelector(".bases-calendar-today-btn"),p=()=>h(-1),m=()=>h(1),g=()=>b(e,n.getFullYear(),n.getMonth(),l,s);o&&(o.addEventListener("click",p),t.push(()=>o.removeEventListener("click",p))),i&&(i.addEventListener("click",m),t.push(()=>i.removeEventListener("click",m))),d&&(d.addEventListener("click",g),t.push(()=>d.removeEventListener("click",g)))}function f(){let e=document.querySelectorAll(".bases-calendar");if(e.length===0)return;let t=[];e.forEach(a=>{L(a,t)}),window.addCleanup&&window.addCleanup(()=>{t.forEach(a=>{a()})})}document.addEventListener("nav",()=>{f()});document.addEventListener("render",()=>{f()});f();
`;
...
function renderRow(entry, columns, view, slug2, allSlugs, linkResolution) {
  ...
  return /* @__PURE__ */ jsx10("tr", { children: columns.map((column) => {
    ...
    return /* @__PURE__ */ jsx10("td", { "data-value": display, style: style2, children: isPrimary ? /* @__PURE__ */ jsx10(
      "a",
      {
        href: transformLink(slug2, entry.slug, transformOpts),
        class: "internal internal-link",
  ...
  return /* @__PURE__ */ jsxs8("div", { class: "bases-table-wrapper", children: [
    ...
    /* @__PURE__ */ jsxs8("table", { class: "bases-table", "data-view-type": "table", children: [
      /* @__PURE__ */ jsx10("thead", { children: /* @__PURE__ */ jsx10("tr", { children: columns.map((column) => {
        const columnWidth = view.columnSize?.[column];
        const style2 = columnWidth ? { width: `${columnWidth}px`, minWidth: `${columnWidth}px` } : void 0;
        return /* @__PURE__ */ jsxs8("th", { "data-column": column, "data-sortable": "true", style: style2, children: [
...
var BasesBody_default = ((opts) => {
  const Component = (props) => {
    ...
    return /* @__PURE__ */ jsxs9("div", { class: "bases-page", "data-initial-view": initialIndex, children: [
      ...
      /* @__PURE__ */ jsx11("div", { class: "bases-view-container", children: views.map((view, index2) => {
