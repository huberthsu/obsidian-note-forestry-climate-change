...
modified: 2026-08-10T18:23:55.488Z
published: 2026-08-10T18:23:55.488Z
tags:
  - 工作流
類別:
  - "[[說明]]"
...
3. Calendar bases
   - 可參考[[考古題筆記]]中的考古題複習日曆，能將工作任務用拖移的方式移動到任一日期
...
- 複習系統
  ...
  - **目的**：定期複習考古題與相關筆記
  - **流程**：
    1. 開啟任務管理/每日任務與複習系統資料夾、calendar提供的日曆、[[考古題筆記]]中的考古題複習日曆，開啟今天需要複習的題目筆記
...
- 管理流程-**以metadata屬性區域作為主要管理工具**
  ...
  4. 創立筆記時，於Metadata的類別欄位選擇[[文獻筆記]]、[[考古題筆記]]、[[靈感與思考]]、[[專案]]、[[說明]]
...
sibling:: [[vault架構與系統.canvas]], [[工作流系統應用.canvas]]
child:: [[文獻筆記工作流]], [[如何發現筆記之間的連結]], [[暫時紀錄的問題與想法]], [[工作區說明]], [[to do]], [[本月目標與預計執行事項]], [[高普考準備工作流.canvas]], [[英文學習工作流.canvas]], [[目標與任務管理系統.canvas]]
